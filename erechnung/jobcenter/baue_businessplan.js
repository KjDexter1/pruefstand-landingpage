...
inhalt.push(
  ...
  platzhalter("Gründerin/Gründer: ", "[Vor- und Nachname]"),
  platzhalter("Anschrift: ", "[Straße, PLZ Ort]"),
  platzhalter("Telefon / E-Mail: ", "[Telefon] / [E-Mail]"),
...
inhalt.push(
  h1("2  Zur Person"),
  platzhalter("Name, Geburtsjahr: ", "[bitte ergänzen]"),
  platzhalter("Schulabschluss und Ausbildung: ", "[bitte ergänzen]"),
  platzhalter("Beruflicher Werdegang: ", "[Stationen, Zeiträume, Tätigkeiten bitte ergänzen]"),
  abstand(80),
  ...
  abstand(80),
  h2("Motivation"),
  p("Die Tätigkeit verbindet eine erlernbare technische Leistung mit einer gesetzlich erzeugten Nachfrage und einem Kundenkreis, der persönlich erreichbar ist. Sie erfordert kein Startkapital, keine Warenlager und keine Angestellten und lässt sich vom ersten Auftrag an tragen."),
);
